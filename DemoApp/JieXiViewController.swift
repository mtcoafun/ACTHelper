...
class JieXiViewController: BaseViewController {
    ...
    @objc func goToSelectKemu(_ gusture:UITapGestureRecognizer)
    {
        print("select kemu")
    ...
    @objc func goToSelectTiKu(_ gusture:UITapGestureRecognizer)
    {
    ...
    @objc func tapFIlterBar(_ gusture:UITapGestureRecognizer)
    {
        switchFilterArea()
    }
