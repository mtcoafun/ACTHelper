...
class FeedBackViewController: BaseViewController {
    ...
    override func viewDidLoad() {
        ...
        let attributes = [NSAttributedString.Key.font: self.font14, NSAttributedString.Key.foregroundColor: self.fontColorDarkGray, NSAttributedString.Key.paragraphStyle: paragraphStyle]
