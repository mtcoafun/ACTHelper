...
class FormRowBlack: UIView, UITextFieldDelegate {
    ...
    var line : UIView!
    weak var controller : BaseAccountSettingViewController!
    ...
    */
    ...
    override init(frame: CGRect) {
        ...
        line.backgroundColor = UIColor(red: 229.0/255, green: 229.0/255, blue: 229.0/255, alpha: 1.0)
    ...
    func setSuccess()
    {
        UIView.animate(withDuration: 0.6, delay: 0.0, options: .curveLinear, animations: {
            ...
            self.labelTitle.textColor = UIColor(red: 74.0/255, green: 74.0/255, blue: 74.0/255, alpha: 1.0)
            self.inputField.textColor = UIColor(red: 74.0/255, green: 74.0/255, blue: 74.0/255, alpha: 1.0)
            self.line.backgroundColor = UIColor(red: 229.0/255, green: 229.0/255, blue: 229.0/255, alpha: 1.0)
    ...
    func textFieldShouldBeginEditing(_ textField: UITextField) -> Bool {
        ...
        self.controller.focusedFieldType = self.labelTitle.text!
        return true
    }
    ...
    @objc func enteringContent(_ notification: Notification?)
    {
