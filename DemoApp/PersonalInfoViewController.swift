...
class PersonalInfoViewController: BaseViewController, UITextFieldDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    //MARK:
    //MARK:打开相册
    @objc func openAlbum(_ gusture:UITapGestureRecognizer)
    {
        ...
        self.imagePickerController.navigationBar.titleTextAttributes = [NSAttributedString.Key.foregroundColor: UIColor.black]
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [UIImagePickerController.InfoKey : Any]) {
        ...
        self.avartaImage.image = info[.originalImage] as? UIImage
