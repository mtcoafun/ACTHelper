...
class FloatPointMenu: UIView {
    ...
    @objc func tapPointMenu(_ gusture:UITapGestureRecognizer)
    {
        if !isExpand
        {
    ...
    @objc func tapPointShow(_ gusture:UITapGestureRecognizer)
    {
    ...
    @objc func tappointClose(_ gusture:UITapGestureRecognizer)
    {
        closeMenu()
    }
